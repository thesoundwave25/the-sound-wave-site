...
coinvolgendo il pubblico, creando un’atmosfera magica ed energica.`,
  ...
  const events = useMemo<EventItem[]>(
    () => [
        ...
        imageSrc: "/locandine/22-MAGGIO.webp",
        cta: "Maggiori dettagli",
        description: "Ingresso gratuito, cucina dalle 19.00 e dalle 21.30 grande party dance 90/2000 con maxi robot, LED show, cosplayer, sparacoriandoli e area bimbi.",
      },
 {
        id: "event-2",
        title: "FESTA DELLA LUCE",
        date: "29 MAGGIO - 01 GIUGNO 2026",
 ...
 {
        id: "event-3",
        title: "FESTA DELLA LUCE - DANCE PARTY",
        date: "29 MAGGIO",
        venue: "CALCINATE - Area feste De Andrè",
        imageSrc: "/locandine/29-MAGGIO.webp",
        cta: "Maggiori dettagli",
        description: "Dalle 21.30 arriva il Dance Party con The Sound Wave e gli special guest del DJH Project: energia, musica e divertimento sotto le stelle. Stand gastronomico dalle 19.00, Dance party dalle 21.30",
      },
       {
        id: "event-4",
        title: "FESTA DELLA LUCE - EMOTION 90/2000",
        date: "30 MAGGIO",
        venue: "CALCINATE - Area feste De Andrè",
        imageSrc: "/locandine/30-MAGGIO.webp",
        cta: "Maggiori dettagli",
        description: "Alla 13ª Festa della Luce arriva una notte tutta da ballare con le hit più iconiche anni 90/2000, insieme a The Sound Wave e agli special guest del DJH Project. Emotion: il viaggio dance che non passa mai di moda!",
      },
       {
        id: "event-5",
        title: "FESTA DELLA LUCE - ITALIAN REMIX PARTY",
        date: "31 MAGGIO",
        venue: "CALCINATE - Area feste De Andrè",
        imageSrc: "/locandine/31-MAGGIO.webp",
        cta: "Maggiori dettagli",
        description: "Una serata esplosiva con il meglio della musica italiana remixata, insieme a The Sound Wave e agli special guest del DJH Project.",
      },
      {
        id: "event-6",
        title: "FESTA DELLA LUCE - ALL DANCE EXPERIENCE",
        date: "1 GIUGNO",
        venue: "CALCINATE - Area feste De Andrè",
        imageSrc: "/locandine/01-GIUGNO.webp",
        cta: "Maggiori dettagli",
        description: "All Dance Experience, il format firmato The Sound Wave pensato per attraversare tutta l’energia della dance, senza confini e senza pause. Special guest i dj del DJH Project.",
      },
       {
        id: "event-7",
        title: "FESTA ORATORIO - ALL DANCE EXPERIENCE",
        date: "2 GIUGNO",
        venue: "CIVIDINO - Oratorio S.Giovanni Bosco ",
        imageSrc: "/locandine/2_GIUGNO-oratorio.webp",
        cta: "Maggiori dettagli",
        description: "Per la Festa dell’Oratorio 2026 arriva All Dance Experience: una serata carica di musica, energia e divertimento con The Sound Wave come special guest.",
      },
      {
        id: "event-8",
